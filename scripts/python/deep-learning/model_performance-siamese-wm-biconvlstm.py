...
if __name__=="__main__":
    print("loading model")
    model_path = '../deep-learning/experiments/convlstm-siamese/temp/model-siamese-epoch-60-ts-1566145957.8629107.pth'
    model = ConvLSTMNet()
    ...
    print("loading data")
    data_list = np.load('../../../data/multilabel/all/mindfulness/siamese/wm/validation/data_siamese_val.npy')
